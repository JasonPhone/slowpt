...
object_list two_perlin_spheres() {
  ...
  objects.add(make_shared<sphere>(point3d{0, -1000, 0}, 1000,
                                  make_shared<lambertian_material>(pertext)));
...
object_list cornell_box() {
  ...
  // 0.796},
  //                                                  color_rgb{0.9, 0.9, 0.9});
  // objects.add(make_shared<sphere>(point3d{400, 150, 300}, 100,
  // make_shared<lambertian_material>(checker_txt1))); auto dielect_mat =
  // make_shared<dielectric_material>(1.5);
  // objects.add(make_shared<sphere>(point3d{150, 350, 150}, 80,
  // dielect_mat));
  return objects;
}
...
object_list final_scene() {
  ...
  // ground
  object_list boxes1;
  auto ground = make_shared<lambertian_material>(color_rgb(0.48, 0.83, 0.53));
  ...
  auto moving_sphere_material =
      make_shared<lambertian_material>(color_rgb(0.7, 0.3, 0.1));
  objects.add(
  ...
  objects.add(make_shared<sphere>(
      ...
      make_shared<metal_material>(color_rgb(0.8, 0.8, 0.9), 1.0)));
